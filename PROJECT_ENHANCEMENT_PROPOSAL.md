...
> **執行狀態（2026-09-02，使用者已核准「照建議推進」）**：Phase A 全部完成；Phase B 的 B5（拆檔）、B4（/display SSE）、B2（詞彙表 + 語言）已落地；**下一步是 B1 連續聆聽與 B3 session / 講義匯出**。§3 的六個問題採用本文的建議值。CLAUDE.md 已改寫為賽後版。
