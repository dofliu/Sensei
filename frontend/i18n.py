...
UI_TEXTS = {
    "zh": {
        ...
        "cont_status_running": "🎧 聆聽中 · 出卡 {cards} · 跳過 {skipped} · 太短 {short} · 佇列滿丟棄 {dropped} 段（{dropped_s} 秒沒進管線）",
        "cont_status_stopped": "已停止 · 這次出卡 {cards} · 跳過 {skipped} · 太短 {short} · 佇列滿丟棄 {dropped} 段（{dropped_s} 秒沒進管線）",
    ...
    "en": {
        ...
        "cont_status_running": "🎧 Listening · {cards} cards · {skipped} skipped · {short} too short · {dropped} dropped ({dropped_s}s never transcribed)",
        "cont_status_stopped": "Stopped · {cards} cards · {skipped} skipped · {short} too short · {dropped} dropped ({dropped_s}s never transcribed)",
